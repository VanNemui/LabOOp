...
public class StoreScreen extends JFrame {
	...
	JPanel createCenter() {
		...
		for (int i = 0; i < store.itemsInStore.length; i++) {
			MediaStore cell = new MediaStore(mediaInStore.length, this.cart);
			center.add(cell);
		}
		return center;
	}
	...
	private class ViewCart implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			new CartScreen(cart, store, storeScreen);
		}
	}
	...
	public class AddBook implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			this.storeScreen.dispose();
			new AddBookToStoreScreen(store, cart, this.storeScreen);
		}
	}
	...
	public class AddDvd implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			this.storeScreen.dispose();
			new AddDvdToStoreScreen(store, cart, this.storeScreen);
		}
	}
	...
	public class AddCd implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			this.storeScreen.dispose();
			new AddCdToStoreScreen(store, cart, this.storeScreen);
		}
	}
}
